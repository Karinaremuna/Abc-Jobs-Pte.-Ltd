...
<head>
	...
	<title>Contact Us - ABC Community Portal</title>
...
<!-- Page Header Start -->
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="margin: 70px 0 0 350px">
            <div class="d-flex flex-column justify-content-between h-100">
              <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                ...
                <div class="ms-4">
                  ...
                  <h3 class="mb-0">+6281339160873</h3>
                </div>
              </div>
              <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-dark" style="width: 55px; height: 55px">
                ...
                <div class="ms-4">
                  ...
                  <h3 class="mb-0">+6285163023108</h3>
                </div>
              </div>
              <div class="bg-light d-flex align-items-center w-100 p-4">
                ...
                <div class="ms-4">
                  ...
                  <h3 class="mb-0">Abcompany@gmail.com</h3>
                </div>
              </div>
            </div>
          </div>
